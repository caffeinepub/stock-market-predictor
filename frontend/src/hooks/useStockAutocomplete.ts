...
const NSE_STOCKS: Stock[] = [
  ...
  { symbol: 'JUBLFOODS', name: 'Jubilant FoodWorks Ltd' },
  ...
  { symbol: 'HEIDELBERG', name: 'Heidelberg Cement India Ltd' },
  ...
  { symbol: 'ADITYA', name: 'Aditya Birla Fashion and Retail Ltd' },
  ...
  { symbol: 'VRL', name: 'VRL Logistics Ltd' },
  ...
  { symbol: 'MAHLIFE', name: 'Mahindra Lifespace Developers Ltd' },
  
  // Textiles & Apparel
  { symbol: 'RAYMOND', name: 'Raymond Ltd' },
  { symbol: 'ARVIND', name: 'Arvind Ltd' },
  { symbol: 'GOKEX', name: 'Gopal Snacks Ltd' },
  { symbol: 'PAGEIND', name: 'Page Industries Ltd' },
  { symbol: 'WELSPUNIND', name: 'Welspun India Ltd' },
  { symbol: 'TRIDENT', name: 'Trident Ltd' },
  { symbol: 'VARDHACRLC', name: 'Vardhman Textiles Ltd' },
  { symbol: 'SPCENET', name: 'Spencer\'s Retail Ltd' },
  ...
  { symbol: 'KSCL', name: 'Kaveri Seed Company Ltd' },
